...
Attack              int     msec
Decay               int     msec
Sustain             float   0<=value<=1. Percentage of the max amplitude value. 
                            If value>0, sustain lasts as long as key is pressed
Release             int     msec
WaveType            string  SQUARE, PULSE, TRIANGLE, SAWTOOTH, or NOISE
Vibrato Amplitutde  float   Maximum amplitude of the vibrato (percentage of the
                            frequency)
Vibrato Period      int     
