...
void TestAdvanceSimple()
{
    ...
    Assert::areNotEqual( 80, polyVoice->phase, "TestAdvanceSimple: Phase should advance\n" );
...
void TestAdvancingRepeatedly()
{
    ...
    polyVoice->advance(1);
    Assert::areNotEqual( expectedPhase, polyVoice->phase, "TestAdvancingRepeatedly: Phase should advance\n" );
